...
import { Package, User, LayoutDashboard, LogOut, Clock, Star, Award, Shield } from 'lucide-react';
            ...
            <table className="w-full">
              ...
              <tbody>
                {orders.length > 0 ? orders.map((o, i) => (
                  ...
                  <tr><td colSpan="3" className="px-6 py-8 text-center text-sm text-gray-500">You have no previous orders.</td></tr>
                )}
              </tbody>
            </table>
          </div>
